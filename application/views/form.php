...
<div class="container-fluid col-lg-10">
	<?php echo form_open_multipart('Member/data');?>
		...
		<div class="form-group">
			<label>Contact </label>
			<?php echo form_input(['name'=>'contact','class'=>'form-control']) ;?>
		</div>
		<div>
		...
		<div class="form-group">
			...
			<?php echo form_input(['type'=>'date','name'=>'birthday','class'=>'form-control']) ;?>
		</div>
		<div>
		...
		<div class="form-group">
			<label>Gender </label>
			<?php echo form_input(['name'=>'gender','class'=>'form-control']) ;?>
		</div>
		<div>
		...
		<div class="form-group">
			<label>Photo </label>
			<?php echo form_input(['type'=>'file','name'=>'photo','class'=>'form-control']) ;?>
		</div>
